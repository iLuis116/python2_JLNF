...
## Listas de Palabras
nombre_de_colores = ["rosa", "morado", "rojo", "azul", "amarillo", "naranja", "cafe", "negro"]
...
print("Desea jugar con palabras de que son nombre de colores o nombres de paises")
time.sleep(2)
 
cat_seleccionada = input("Ingrese C para nombre de colores y P para nombres de paises: ")
 
while True:
    if cat_seleccionada.lower() == "c":
        print("excelente a seleccionado nombre de colores")
        palabra_secreta = random.choice(nombre_de_colores)
        break
